...
lt_brailleData = pd.read_csv(script_directory / Path('alternate meanings - lettersnumbers.csv'))
df_lt_brailleData = pd.DataFrame(lt_brailleData)

partial_brailleData = pd.read_csv(
    script_directory / Path('alternate meanings - partial_and_connected.csv'))
df_partial_brailleData = pd.DataFrame(partial_brailleData)

whole_brailleData = pd.read_csv(script_directory / Path('alternate meanings - all_abrs.csv'))
df_whole_brailleData = pd.DataFrame(whole_brailleData)

isolated_brailleData = pd.read_csv(
    script_directory / Path('alternate meanings - isolated_words.csv'))
df_isolated_brailleData = pd.DataFrame(isolated_brailleData)

single_brailleData = pd.read_csv(
    script_directory / Path('alternate meanings - single_words.csv'))
